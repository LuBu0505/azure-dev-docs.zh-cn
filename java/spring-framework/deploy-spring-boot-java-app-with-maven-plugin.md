---
title: 使用 Maven 将 Spring Boot JAR 文件应用部署到 Azure
...
ms.locfileid: "69889812"
---
# <a name="deploy-a-spring-boot-web-app-to-azure-app-service-on-linux"></a>将 Spring Boot Web 应用部署到 Linux 上的 Azure 应用服务
