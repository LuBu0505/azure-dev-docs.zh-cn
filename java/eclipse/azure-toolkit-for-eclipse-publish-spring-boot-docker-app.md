...
ms.locfileid: "75191113"
---
# <a name="publish-a-spring-boot-app-as-a-docker-container-by-using-the-azure-toolkit-for-eclipse-deprecated"></a>使用 Azure Toolkit for Eclipse 将 Spring Boot 应用作为 Docker 容器发布（已弃用）
