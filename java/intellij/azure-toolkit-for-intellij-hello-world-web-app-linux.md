...
1. 启动 IntelliJ，并按照[用于 IntelliJ 的 Azure 工具包的登录说明](https://docs.microsoft.com/azure/java/intellij/azure-toolkit-for-intellij-sign-in-instructions)一文中的步骤登录 Azure 帐户。
