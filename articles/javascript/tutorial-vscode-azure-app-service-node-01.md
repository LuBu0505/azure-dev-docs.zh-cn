...
description: Node.js 教程第 1 部分：简介和先决条件。
ms.topic: tutorial
ms.date: 03/04/2020
...
ms.locfileid: "91365180"
---
# <a name="deploy-nodejs-to-azure-app-service-using-visual-studio-code"></a>使用 Visual Studio Code 将 Node.js 部署到 Azure 应用服务
