...
- [SQL 数据库 - Spring Data JDBC](../spring-framework/configure-spring-data-jdbc-with-azure-sql-server.md)
- [SQL 数据库 - Spring Data JPA](../spring-framework/configure-spring-data-jpa-with-azure-sql-server.md)
