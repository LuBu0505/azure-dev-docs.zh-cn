...
description: 将第一个 Python 应用部署到应用服务中的 Linux 容器即可开始使用 Azure 应用服务。
ms.topic: quickstart
ms.date: 09/22/2020
...
## <a name="2-clone-the-sample"></a>2.克隆示例
...
## <a name="3-run-the-sample"></a>3.运行示例
...
## <a name="4-deploy-the-sample"></a>4.部署示例
...
- 如果无法识别 `az` 命令，请确保按照[设置初始环境](#setup)中所述安装 Azure CLI。
...
## <a name="5-browse-to-the-app"></a>5.浏览到应用
...
## <a name="6-redeploy-updates"></a>6.重新部署更新
...
## <a name="7-stream-logs"></a>7.流式传输日志
...
## <a name="8-manage-the-azure-app"></a>8.管理 Azure 应用
