...
| 选择 **Azure 门户**右上角菜单栏上的 [Cloud Shell](https://portal.azure.com) 按钮。 | ![Azure 门户中的“Cloud Shell”按钮](./media/cloud-shell-try-it/hdi-cloud-shell-menu.png) |
